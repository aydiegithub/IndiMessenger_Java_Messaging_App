...
public class com_apsapps_indimessenger_models_StatusRealmProxy extends com.apsapps.indimessenger.models.Status
    implements RealmObjectProxy, com_apsapps_indimessenger_models_StatusRealmProxyInterface {
    ...
    private ProxyState<com.apsapps.indimessenger.models.Status> proxyState;
    private RealmList<com.apsapps.indimessenger.models.StatusImage> statusImagesRealmList;

    com_apsapps_indimessenger_models_StatusRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.apsapps.indimessenger.models.Status>(this);
    ...
    @Override
    public RealmList<com.apsapps.indimessenger.models.StatusImage> realmGet$statusImages() {
        ...
        if (statusImagesRealmList != null) {
            ...
            statusImagesRealmList = new RealmList<com.apsapps.indimessenger.models.StatusImage>(com.apsapps.indimessenger.models.StatusImage.class, osList, proxyState.getRealm$realm());
            return statusImagesRealmList;
        }
    }

    @Override
    public void realmSet$statusImages(RealmList<com.apsapps.indimessenger.models.StatusImage> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.apsapps.indimessenger.models.StatusImage> original = value;
                value = new RealmList<com.apsapps.indimessenger.models.StatusImage>();
                for (com.apsapps.indimessenger.models.StatusImage item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.apsapps.indimessenger.models.StatusImage linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static com.apsapps.indimessenger.models.Status createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        com.apsapps.indimessenger.models.Status obj = realm.createObjectInternal(com.apsapps.indimessenger.models.Status.class, true, excludeFields);

        final com_apsapps_indimessenger_models_StatusRealmProxyInterface objProxy = (com_apsapps_indimessenger_models_StatusRealmProxyInterface) obj;
        if (json.has("statusImages")) {
            if (json.isNull("statusImages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.apsapps.indimessenger.models.StatusImage item = com_apsapps_indimessenger_models_StatusImageRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.apsapps.indimessenger.models.Status createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.apsapps.indimessenger.models.Status obj = new com.apsapps.indimessenger.models.Status();
        final com_apsapps_indimessenger_models_StatusRealmProxyInterface objProxy = (com_apsapps_indimessenger_models_StatusRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$statusImages(new RealmList<com.apsapps.indimessenger.models.StatusImage>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.apsapps.indimessenger.models.StatusImage item = com_apsapps_indimessenger_models_StatusImageRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$statusImages().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.apsapps.indimessenger.models.Status copyOrUpdate(Realm realm, com.apsapps.indimessenger.models.Status object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.apsapps.indimessenger.models.Status) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.apsapps.indimessenger.models.Status copy(Realm realm, com.apsapps.indimessenger.models.Status newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.apsapps.indimessenger.models.Status realmObject = realm.createObjectInternal(com.apsapps.indimessenger.models.Status.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_apsapps_indimessenger_models_StatusRealmProxyInterface realmObjectSource = (com_apsapps_indimessenger_models_StatusRealmProxyInterface) newObject;
        com_apsapps_indimessenger_models_StatusRealmProxyInterface realmObjectCopy = (com_apsapps_indimessenger_models_StatusRealmProxyInterface) realmObject;


        RealmList<com.apsapps.indimessenger.models.StatusImage> statusImagesList = realmObjectSource.realmGet$statusImages();
        if (statusImagesList != null) {
            RealmList<com.apsapps.indimessenger.models.StatusImage> statusImagesRealmList = realmObjectCopy.realmGet$statusImages();
            statusImagesRealmList.clear();
            for (int i = 0; i < statusImagesList.size(); i++) {
                com.apsapps.indimessenger.models.StatusImage statusImagesItem = statusImagesList.get(i);
                com.apsapps.indimessenger.models.StatusImage cachestatusImages = (com.apsapps.indimessenger.models.StatusImage) cache.get(statusImagesItem);
                if (cachestatusImages != null) {
                    statusImagesRealmList.add(cachestatusImages);
                } else {
                    statusImagesRealmList.add(com_apsapps_indimessenger_models_StatusImageRealmProxy.copyOrUpdate(realm, statusImagesItem, update, cache));
                }
            }
        }
    ...
    public static long insert(Realm realm, com.apsapps.indimessenger.models.Status object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.apsapps.indimessenger.models.Status.class);
        long tableNativePtr = table.getNativePtr();
        StatusColumnInfo columnInfo = (StatusColumnInfo) realm.getSchema().getColumnInfo(com.apsapps.indimessenger.models.Status.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);

        RealmList<com.apsapps.indimessenger.models.StatusImage> statusImagesList = ((com_apsapps_indimessenger_models_StatusRealmProxyInterface) object).realmGet$statusImages();
        if (statusImagesList != null) {
            OsList statusImagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.statusImagesIndex);
            for (com.apsapps.indimessenger.models.StatusImage statusImagesItem : statusImagesList) {
                Long cacheItemIndexstatusImages = cache.get(statusImagesItem);
                if (cacheItemIndexstatusImages == null) {
                    cacheItemIndexstatusImages = com_apsapps_indimessenger_models_StatusImageRealmProxy.insert(realm, statusImagesItem, cache);
                }
                statusImagesOsList.addRow(cacheItemIndexstatusImages);
            }
        }
        String realmGet$lastMessage = ((com_apsapps_indimessenger_models_StatusRealmProxyInterface) object).realmGet$lastMessage();
        if (realmGet$lastMessage != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastMessageIndex, rowIndex, realmGet$lastMessage, false);
        }
        String realmGet$myId = ((com_apsapps_indimessenger_models_StatusRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$userId = ((com_apsapps_indimessenger_models_StatusRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        String realmGet$groupId = ((com_apsapps_indimessenger_models_StatusRealmProxyInterface) object).realmGet$groupId();
        if (realmGet$groupId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.groupIdIndex, rowIndex, realmGet$groupId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((com_apsapps_indimessenger_models_StatusRealmProxyInterface) object).realmGet$timeUpdated(), false);

        com.apsapps.indimessenger.models.User userObj = ((com_apsapps_indimessenger_models_StatusRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
        ...
        com.apsapps.indimessenger.models.Group groupObj = ((com_apsapps_indimessenger_models_StatusRealmProxyInterface) object).realmGet$group();
        if (groupObj != null) {
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.readIndex, rowIndex, ((com_apsapps_indimessenger_models_StatusRealmProxyInterface) object).realmGet$read(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        StatusColumnInfo columnInfo = (StatusColumnInfo) realm.getSchema().getColumnInfo(com.apsapps.indimessenger.models.Status.class);
        com.apsapps.indimessenger.models.Status object = null;
        while (objects.hasNext()) {
            object = (com.apsapps.indimessenger.models.Status) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.apsapps.indimessenger.models.Status object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.apsapps.indimessenger.models.Status.class);
        ...
        if (statusImagesList != null && statusImagesList.size() == statusImagesOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexstatusImages = cache.get(statusImagesItem);
                if (cacheItemIndexstatusImages == null) {
                    cacheItemIndexstatusImages = com_apsapps_indimessenger_models_StatusImageRealmProxy.insertOrUpdate(realm, statusImagesItem, cache);
                }
    ...
    public static com.apsapps.indimessenger.models.Status createDetachedCopy(com.apsapps.indimessenger.models.Status realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.apsapps.indimessenger.models.Status unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.apsapps.indimessenger.models.Status();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.apsapps.indimessenger.models.Status) cachedObject.object;
            }
            unmanagedObject = (com.apsapps.indimessenger.models.Status) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_apsapps_indimessenger_models_StatusRealmProxyInterface unmanagedCopy = (com_apsapps_indimessenger_models_StatusRealmProxyInterface) unmanagedObject;
        com_apsapps_indimessenger_models_StatusRealmProxyInterface realmSource = (com_apsapps_indimessenger_models_StatusRealmProxyInterface) realmObject;

        // Deep copy of statusImages
        if (currentDepth == maxDepth) {
            unmanagedCopy.realmSet$statusImages(null);
        } else {
            RealmList<com.apsapps.indimessenger.models.StatusImage> managedstatusImagesList = realmSource.realmGet$statusImages();
            RealmList<com.apsapps.indimessenger.models.StatusImage> unmanagedstatusImagesList = new RealmList<com.apsapps.indimessenger.models.StatusImage>();
            unmanagedCopy.realmSet$statusImages(unmanagedstatusImagesList);
            int nextDepth = currentDepth + 1;
            int size = managedstatusImagesList.size();
            for (int i = 0; i < size; i++) {
                com.apsapps.indimessenger.models.StatusImage item = com_apsapps_indimessenger_models_StatusImageRealmProxy.createDetachedCopy(managedstatusImagesList.get(i), nextDepth, maxDepth, cache);
    ...
    public boolean equals(Object o) {
        ...
        com_apsapps_indimessenger_models_StatusRealmProxy aStatus = (com_apsapps_indimessenger_models_StatusRealmProxy)o;
