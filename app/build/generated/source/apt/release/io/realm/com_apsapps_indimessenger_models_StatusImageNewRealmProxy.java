...
public class com_apsapps_indimessenger_models_StatusImageNewRealmProxy extends com.apsapps.indimessenger.models.StatusImageNew
    implements RealmObjectProxy, com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface {
    ...
    private ProxyState<com.apsapps.indimessenger.models.StatusImageNew> proxyState;

    com_apsapps_indimessenger_models_StatusImageNewRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.apsapps.indimessenger.models.StatusImageNew>(this);
    ...
    @SuppressWarnings("cast")
    public static com.apsapps.indimessenger.models.StatusImageNew createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("attachment")) {
            excludeFields.add("attachment");
        }
        com.apsapps.indimessenger.models.StatusImageNew obj = realm.createObjectInternal(com.apsapps.indimessenger.models.StatusImageNew.class, true, excludeFields);

        final com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface objProxy = (com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) obj;
        if (json.has("body")) {
            if (json.isNull("body")) {
    ...
    public static com.apsapps.indimessenger.models.StatusImageNew createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.apsapps.indimessenger.models.StatusImageNew obj = new com.apsapps.indimessenger.models.StatusImageNew();
        final com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface objProxy = (com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.apsapps.indimessenger.models.StatusImageNew copyOrUpdate(Realm realm, com.apsapps.indimessenger.models.StatusImageNew object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.apsapps.indimessenger.models.StatusImageNew) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.apsapps.indimessenger.models.StatusImageNew copy(Realm realm, com.apsapps.indimessenger.models.StatusImageNew newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.apsapps.indimessenger.models.StatusImageNew realmObject = realm.createObjectInternal(com.apsapps.indimessenger.models.StatusImageNew.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface realmObjectSource = (com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) newObject;
        com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface realmObjectCopy = (com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.apsapps.indimessenger.models.StatusImageNew object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.apsapps.indimessenger.models.StatusImageNew.class);
        long tableNativePtr = table.getNativePtr();
        StatusImageNewColumnInfo columnInfo = (StatusImageNewColumnInfo) realm.getSchema().getColumnInfo(com.apsapps.indimessenger.models.StatusImageNew.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$body = ((com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) object).realmGet$body();
        if (realmGet$body != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.bodyIndex, rowIndex, realmGet$body, false);
        }
        String realmGet$senderName = ((com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) object).realmGet$senderName();
        ...
        String realmGet$senderId = ((com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) object).realmGet$senderId();
        if (realmGet$senderId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.senderIdIndex, rowIndex, realmGet$senderId, false);
        }
        String realmGet$id = ((com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.dateIndex, rowIndex, ((com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) object).realmGet$date(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.deliveredIndex, rowIndex, ((com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) object).realmGet$delivered(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.sentIndex, rowIndex, ((com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) object).realmGet$sent(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.attachmentTypeIndex, rowIndex, ((com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) object).realmGet$attachmentType(), false);

        com.apsapps.indimessenger.models.AttachmentList attachmentObj = ((com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) object).realmGet$attachment();
        if (attachmentObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        StatusImageNewColumnInfo columnInfo = (StatusImageNewColumnInfo) realm.getSchema().getColumnInfo(com.apsapps.indimessenger.models.StatusImageNew.class);
        com.apsapps.indimessenger.models.StatusImageNew object = null;
        while (objects.hasNext()) {
            object = (com.apsapps.indimessenger.models.StatusImageNew) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.apsapps.indimessenger.models.StatusImageNew object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.apsapps.indimessenger.models.StatusImageNew.class);
    ...
    public static com.apsapps.indimessenger.models.StatusImageNew createDetachedCopy(com.apsapps.indimessenger.models.StatusImageNew realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.apsapps.indimessenger.models.StatusImageNew unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.apsapps.indimessenger.models.StatusImageNew();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.apsapps.indimessenger.models.StatusImageNew) cachedObject.object;
            }
            unmanagedObject = (com.apsapps.indimessenger.models.StatusImageNew) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface unmanagedCopy = (com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) unmanagedObject;
        com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface realmSource = (com_apsapps_indimessenger_models_StatusImageNewRealmProxyInterface) realmObject;
