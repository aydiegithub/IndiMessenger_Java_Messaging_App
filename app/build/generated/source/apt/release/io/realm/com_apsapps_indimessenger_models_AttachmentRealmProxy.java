...
public class com_apsapps_indimessenger_models_AttachmentRealmProxy extends com.apsapps.indimessenger.models.Attachment
    implements RealmObjectProxy, com_apsapps_indimessenger_models_AttachmentRealmProxyInterface {
    ...
    private ProxyState<com.apsapps.indimessenger.models.Attachment> proxyState;

    com_apsapps_indimessenger_models_AttachmentRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.apsapps.indimessenger.models.Attachment>(this);
    ...
    @SuppressWarnings("cast")
    public static com.apsapps.indimessenger.models.Attachment createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.apsapps.indimessenger.models.Attachment obj = realm.createObjectInternal(com.apsapps.indimessenger.models.Attachment.class, true, excludeFields);

        final com_apsapps_indimessenger_models_AttachmentRealmProxyInterface objProxy = (com_apsapps_indimessenger_models_AttachmentRealmProxyInterface) obj;
        if (json.has("name")) {
            if (json.isNull("name")) {
    ...
    public static com.apsapps.indimessenger.models.Attachment createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.apsapps.indimessenger.models.Attachment obj = new com.apsapps.indimessenger.models.Attachment();
        final com_apsapps_indimessenger_models_AttachmentRealmProxyInterface objProxy = (com_apsapps_indimessenger_models_AttachmentRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.apsapps.indimessenger.models.Attachment copyOrUpdate(Realm realm, com.apsapps.indimessenger.models.Attachment object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.apsapps.indimessenger.models.Attachment) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.apsapps.indimessenger.models.Attachment copy(Realm realm, com.apsapps.indimessenger.models.Attachment newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.apsapps.indimessenger.models.Attachment realmObject = realm.createObjectInternal(com.apsapps.indimessenger.models.Attachment.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_apsapps_indimessenger_models_AttachmentRealmProxyInterface realmObjectSource = (com_apsapps_indimessenger_models_AttachmentRealmProxyInterface) newObject;
        com_apsapps_indimessenger_models_AttachmentRealmProxyInterface realmObjectCopy = (com_apsapps_indimessenger_models_AttachmentRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.apsapps.indimessenger.models.Attachment object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.apsapps.indimessenger.models.Attachment.class);
        long tableNativePtr = table.getNativePtr();
        AttachmentColumnInfo columnInfo = (AttachmentColumnInfo) realm.getSchema().getColumnInfo(com.apsapps.indimessenger.models.Attachment.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$name = ((com_apsapps_indimessenger_models_AttachmentRealmProxyInterface) object).realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nameIndex, rowIndex, realmGet$name, false);
        }
        String realmGet$data = ((com_apsapps_indimessenger_models_AttachmentRealmProxyInterface) object).realmGet$data();
        if (realmGet$data != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.dataIndex, rowIndex, realmGet$data, false);
        }
        String realmGet$url = ((com_apsapps_indimessenger_models_AttachmentRealmProxyInterface) object).realmGet$url();
        if (realmGet$url != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.urlIndex, rowIndex, realmGet$url, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.bytesCountIndex, rowIndex, ((com_apsapps_indimessenger_models_AttachmentRealmProxyInterface) object).realmGet$bytesCount(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        AttachmentColumnInfo columnInfo = (AttachmentColumnInfo) realm.getSchema().getColumnInfo(com.apsapps.indimessenger.models.Attachment.class);
        com.apsapps.indimessenger.models.Attachment object = null;
        while (objects.hasNext()) {
            object = (com.apsapps.indimessenger.models.Attachment) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.apsapps.indimessenger.models.Attachment object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.apsapps.indimessenger.models.Attachment.class);
    ...
    public static com.apsapps.indimessenger.models.Attachment createDetachedCopy(com.apsapps.indimessenger.models.Attachment realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.apsapps.indimessenger.models.Attachment unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.apsapps.indimessenger.models.Attachment();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.apsapps.indimessenger.models.Attachment) cachedObject.object;
            }
            unmanagedObject = (com.apsapps.indimessenger.models.Attachment) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_apsapps_indimessenger_models_AttachmentRealmProxyInterface unmanagedCopy = (com_apsapps_indimessenger_models_AttachmentRealmProxyInterface) unmanagedObject;
        com_apsapps_indimessenger_models_AttachmentRealmProxyInterface realmSource = (com_apsapps_indimessenger_models_AttachmentRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_apsapps_indimessenger_models_AttachmentRealmProxy aAttachment = (com_apsapps_indimessenger_models_AttachmentRealmProxy)o;
